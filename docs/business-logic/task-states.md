...
| COMPLETED | 基本資訊 + 評價 | 基本資訊 + 評價 | 聯絡資訊隱藏，可刪除記錄 |
...
### 任務取消
- **PENDING 狀態**: 小怕星可直接刪除任務
- **PENDING_CONFIRMATION 狀態**: 小怕星可取消任務，需通知已申請的終結者
- **IN_PROGRESS 狀態**: 不可取消，只能等待完成
- **COMPLETED 狀態**: 雙方都可以刪除任務記錄
